...
调用1do接口时，需使用HTTPS,HTTP协议、JSON数据格式、UTF8编码，默认POST请求请在HTTP Header中设置 Content-Type:application/json。
...
| 字段             | 字段名           | 描述及要求                                                   |
| ---------------- | ---------------- | ------------------------------------------------------------ |
| SHOW_ID          | 1do工单编号      | 1do工单编号                                                  |
| O_DESCRIBE       | 内容             | 内容                                                         |
| O_EXECUTOR_NAME  | 参与人姓名       | 多个参与人以“;”隔开，如："方升群;谢洁"                       |
| O_EXECUTOR       | 参与人姓名showid | 多个参与人以“;”隔开，如：“XzaqamVZPDtAR3WP;297NKDKkDzHZe2da" |
| SOURCE           | 来源             | 来源 0、全部  1、call 或者oa 2、主动办 3、三实库 4、其他 5、领导批示6.城市大脑,7综合信息系统，8、1call办9、城市大脑综合指挥平台 10、督查指挥，11云上城管，12百姓爆料，13红旗班 |
| O_TYPE_ID        | 事件类型         | 目前默认：0；；来源为1call办时（1、城管执法，2、民政，3、环卫，4、住建，5、人社）后续增加另行通知 |
| O_CREATE_TIME    | 创建时间         | 创建时间                                                     |
| O_CUSTOMER_NAME  | 发起人姓名       | 多个发起人以“;”隔开，如："方升群;谢洁"                       |
| O_CUSTOMER       | 发起人姓名showid | 多个发起人以“;”隔开，如："XzaqamVZPDtAR3WP;297NKDKkDzHZe2da" |
| REAL_FINISH_TIME | 办结时间         | 办结时间                                                     |
| O_FINISH_TIME    | 完成时间         | 拟完成时间                                                   |
| O_STATUS         | 工单状态         | 处理状态 3.待接单 4.处理中 5.已完成  0.全部                  |
| O_SOURE_NAME     | 来源名称         | 来源名称对应SOURCE。                                         |
