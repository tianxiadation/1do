...
public abstract class BaseT1doFeedback<M extends BaseT1doFeedback<M>> extends Model<M> implements IBean {
	...
	public M setTemp(java.lang.Integer temp) {
		set("temp", temp);
		return (M)this;
	}
	...
	public M setIsCreateReport(java.lang.Boolean isCreateReport) {
		set("IS_CREATE_REPORT", isCreateReport);
		return (M)this;
	}
	
	public java.lang.Boolean getIsCreateReport() {
		return get("IS_CREATE_REPORT");
	}

	public M setCallMessage(java.lang.String callMessage) {
		set("callMessage", callMessage);
		return (M)this;
	}
	
	public java.lang.String getCallMessage() {
		return getStr("callMessage");
	}
