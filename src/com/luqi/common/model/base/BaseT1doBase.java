...
public abstract class BaseT1doBase<M extends BaseT1doBase<M>> extends Model<M> implements IBean {
	...
	public M setRecordSimilarity(java.lang.Integer recordSimilarity) {
		set("RECORD_SIMILARITY", recordSimilarity);
		return (M)this;
	}
	
	public java.lang.Integer getRecordSimilarity() {
		return getInt("RECORD_SIMILARITY");
	}
	...
	public java.lang.String getEventId() {
		return getStr("eventId");
	}

	public M setCommandPlatformId(java.lang.String commandPlatformId) {
		set("COMMAND_PLATFORM_ID", commandPlatformId);
		return (M)this;
	}
	
	public java.lang.String getCommandPlatformId() {
		return getStr("COMMAND_PLATFORM_ID");
	}

	public M setIsSuccess(java.lang.Boolean isSuccess) {
	...
	public M setWechatGroupName(java.lang.String wechatGroupName) {
		set("WECHAT_GROUP_NAME", wechatGroupName);
		return (M)this;
	}
	
	public java.lang.String getWechatGroupName() {
		return getStr("WECHAT_GROUP_NAME");
	}

	public M setIsBindingWechatGroup(java.lang.Boolean isBindingWechatGroup) {
		set("IS_BINDING_WECHAT_GROUP", isBindingWechatGroup);
		return (M)this;
	}
	
	public java.lang.Boolean getIsBindingWechatGroup() {
		return get("IS_BINDING_WECHAT_GROUP");
	}

	public M setWechatGroupId(java.lang.String wechatGroupId) {
		set("WECHAT_GROUP_ID", wechatGroupId);
		return (M)this;
	}
	
	public java.lang.String getWechatGroupId() {
		return getStr("WECHAT_GROUP_ID");
	}
