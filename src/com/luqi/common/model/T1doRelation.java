...
import com.luqi.common.model.base.BaseT1doRelation;
...
public class T1doRelation extends BaseT1doRelation<T1doRelation> {
	...
	*/
	...
	public static List<Record> selectRelation(String showId,String sql) {
		return Db.find("select  a.ID,a.SIMILARITY,b.SHOW_ID,a.TYPE,b.O_TITLE O_DESCRIBE,unix_timestamp(b.O_CREATE_TIME)*1000 O_CREATE_TIME,unix_timestamp(b.O_FINISH_TIME)*1000 O_FINISH_TIME,b.FBNUM,b.LOOKNUM,"
				...
				+ "where (a.SIMILARITY>b.SIMILARITY or a.TYPE<=0) and a.type!=7 and a.RELATION_SHOW_ID=b.SHOW_ID and a.SHOW_ID=? and b.O_STATUS!=6 "+sql+" ORDER BY a.SORT,a.SIMILARITY desc",showId);
	}
	/*
	...
	*/
	...
	//修改1do传送门关联表状态
	public static void updateType(int TYPE, String SHOW_ID) {
		Db.update("update t_1do_relation set TYPE=? where  RELATION_SHOW_ID=?",TYPE,SHOW_ID);
	}
}
