...
import com.luqi.common.model.base.BaseT1doRecord;
...
public class T1doRecord extends BaseT1doRecord<T1doRecord> {
	...
	*/
	...
	public static void batchSaveForTime() {
		...
		records.forEach(t->{
			try {
				TRegUser.addUser(t.getStr("ACCOUNT"));
			} catch (Exception e) {
		...
		Db.update("update t_1do_pstatus set online=2 where gmt_modified<CURDATE()");
