...
import com.luqi.common.model.base.BaseT1doFeedback;
...
public class T1doFeedback extends BaseT1doFeedback<T1doFeedback>  {
	...
	*/
	public static List<T1doFeedback> getExecutorFeedbacks(String showId) {
		return dao.find("select * from  t_1do_feedback where SHOW_ID=? and O_USER!='1G983BNW5WUjPvN9' and Fb_TYPE!=8 and Fb_TYPE!=7",showId);
	}
}
